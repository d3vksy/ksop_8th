  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${dark ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        {/* 헤더 */}
        <header className={`mb-8 p-6 rounded-lg shadow-lg ${dark ? 'bg-gray-800' : 'bg-white'
          }`}>
        ...
        */}
        <section className={`mb-8 p-6 rounded-lg shadow-lg ${dark ? 'bg-gray-800' : 'bg-white'
          }`}>
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <div className={`text-5xl font-bold min-w-[100px] text-center ${dark ? 'text-white' : 'text-gray-800'
              }`}>
              {count}
            </div>
        ...
        */}
        <section className={`mb-8 p-6 rounded-lg shadow-lg ${dark ? 'bg-gray-800' : 'bg-white'
          ...
          <div className="flex items-center justify-center">
            <button
              onClick={() => setLiked(!liked)}
              className={`px-8 py-4 rounded-lg font-bold text-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2 ${liked
        ...
        <section className={`mb-8 p-6 rounded-lg shadow-lg ${dark ? 'bg-gray-800' : 'bg-white'
          ...
          <div className="flex gap-2 mb-4">
            <input
              ...
              className={`flex-1 px-4 py-2 rounded-lg border-2 focus:outline-none focus:ring-2 ${dark
          ...
          {/* 댓글 목록 */}
          <div className={`rounded-lg ${dark ? 'bg-gray-700' : 'bg-gray-50'
            }`}>
            {posts.length === 0 ? (
        ...
        <section className={`mb-8 p-6 rounded-lg shadow-lg ${dark ? 'bg-gray-800' : 'bg-white'
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              className={`px-8 py-4 rounded-lg font-bold text-lg shadow-md hover:shadow-lg transition-all ${dark
        ...
        */}
        <section className={`p-6 rounded-lg shadow-lg border-2 ${dark
          ...
          <div className={`p-6 rounded-lg mb-4 ${dark ? 'bg-gray-700' : 'bg-white'
            }`}>
            <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-300">
              ...
              <button
                onClick={() => setLiked(!liked)}
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${liked
                  ? 'bg-red-500 hover:bg-red-600 text-white'
                  : 'bg-gray-200 hover:bg-gray-300 text-gray-700'
                  }`}
              >
            ...
            <div className={`mt-4 p-4 rounded-lg ${dark ? 'bg-gray-600' : 'bg-gray-50'
              }`}>
